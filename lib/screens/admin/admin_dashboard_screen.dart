...
import 'package:green_share/screens/admin/charity_requests_tab.dart';
import 'package:green_share/screens/admin/feedback_hub_tab.dart';
import 'package:green_share/screens/admin/user_reports_tab.dart';
        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: [
              ...
              Tab(text: context.l10n.requests, icon: const Icon(Icons.assignment)),
              Tab(text: context.l10n.reports, icon: const Icon(Icons.gavel)),
